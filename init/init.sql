...
ALTER TABLE "contest"
    ADD FOREIGN KEY ("difficulty_id") REFERENCES "contest_diff" ("id");
...
ALTER TABLE "solution"
    ADD FOREIGN KEY ("verdict_id") REFERENCES "verdict" ("id");
...
INSERT INTO verdict (id, description)
VALUES (1, 'OK'),
       (2, 'Time limit'),
       (3, 'Memory limit'),
